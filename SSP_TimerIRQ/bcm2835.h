...
/*! \mainpage C library for Broadcom BCM 2835 as used in Raspberry Pi
  ...
  64 bytes dues to read buffer filling. Patched by Peter W端rtz.

  \version 1.29 Further fix to SPI from Peter W端rtz.
  ...
  Debian packages). Contributed by Guido G端nther.
